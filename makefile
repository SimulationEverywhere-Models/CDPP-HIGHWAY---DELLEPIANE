...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  aceptador.o cola.o despachador.o interseccion.o mytools.o register.o retardador.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#9
...
#^|
aceptador.o: /cygdrive/C/eclipse/workspace/guigui/aceptador.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
cola.o: /cygdrive/C/eclipse/workspace/guigui/cola.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
despachador.o: /cygdrive/C/eclipse/workspace/guigui/despachador.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
interseccion.o: /cygdrive/C/eclipse/workspace/guigui/interseccion.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
mytools.o: /cygdrive/C/eclipse/workspace/guigui/mytools.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/guigui/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
retardador.o: /cygdrive/C/eclipse/workspace/guigui/retardador.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
aceptador.o: /cygdrive/C/eclipse/workspace/guigui/aceptador.cpp \
 /cygdrive/C/eclipse/workspace/guigui/aceptador.h \
...
cola.o: /cygdrive/C/eclipse/workspace/guigui/cola.cpp \
 /cygdrive/C/eclipse/workspace/guigui/cola.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
despachador.o: /cygdrive/C/eclipse/workspace/guigui/despachador.cpp \
 /cygdrive/C/eclipse/workspace/guigui/despachador.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
interseccion.o: /cygdrive/C/eclipse/workspace/guigui/interseccion.cpp \
 /cygdrive/C/eclipse/workspace/guigui/interseccion.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h \
 /cygdrive/C/eclipse/workspace/guigui/mytools.h
mytools.o: /cygdrive/C/eclipse/workspace/guigui/mytools.cpp \
 /cygdrive/C/eclipse/workspace/guigui/mytools.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/time.h
register.o: /cygdrive/C/eclipse/workspace/guigui/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/guigui/cola.h \
 /cygdrive/C/eclipse/workspace/guigui/aceptador.h \
 /cygdrive/C/eclipse/workspace/guigui/retardador.h \
 /cygdrive/C/eclipse/workspace/guigui/despachador.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/distri.h \
 /cygdrive/C/eclipse/workspace/guigui/interseccion.h
retardador.o: /cygdrive/C/eclipse/workspace/guigui/retardador.cpp \
